...
const LeftIcons = () => {
  ...
  return (
    <div className="icons">
      <div className={menu ? "icons-menu-click" : "none"}></div>
      ...
      <div className="icon-full">
        ...
        <div className="icons-chat">
          <svg
            ...
            height="30"
            fill="currentColor"
            class="bi bi-chat-left-text text-white"
            viewBox="0 0 16 16"
          >
        ...
        <div className="icons-shaxsiy">
          ...
          <p className="text-white">Shaxsiy</p>
        </div>

        <div className="icons-channel">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="30"
            height="30"
            fill="currentColor"
            class="bi bi-headset text-white"
            viewBox="0 0 16 16"
          >
        ...
        <div className="icons-oqilmagan">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="30"
            height="30"
            fill="currentColor"
            class="bi bi-chat-dots-fill text-white"
            viewBox="0 0 16 16"
          >
        ...
        <div className="icons-edit">
          <svg
            ...
            height="30"
            fill="currentColor"
            class="bi bi-sliders text-white"
            viewBox="0 0 16 16"
          >
            <path
              fill-rule="evenodd"
